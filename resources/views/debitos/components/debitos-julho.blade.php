<div class="accordion-item mt-3">
    <h2 class="accordion-header" id="headingDebitoJulho">
    ...
    <div id="collapseJulho" class="accordion-collapse collapse {{ verificarMesAtualShow(\App\Models\Mes::JULHO) }}" aria-labelledby="headingDebitoJulho" data-bs-parent="#accordionExample">
