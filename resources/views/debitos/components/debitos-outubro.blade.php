<div class="accordion-item mt-3">
    <h2 class="accordion-header" id="headingDebitoOutubro">
    ...
    <div id="collapseOutubro" class="accordion-collapse collapse {{ verificarMesAtualShow(\App\Models\Mes::SETEMBRO) }}" aria-labelledby="headingDebitoOutubro" data-bs-parent="#accordionExample">
