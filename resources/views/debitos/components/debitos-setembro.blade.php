<div class="accordion-item mt-3">
    <h2 class="accordion-header" id="headingDebitoSetembro">
    ...
    <div id="collapseSetembro" class="accordion-collapse collapse {{ verificarMesAtualShow(\App\Models\Mes::SETEMBRO) }}" aria-labelledby="headingDebitoSetembro" data-bs-parent="#accordionExample">
