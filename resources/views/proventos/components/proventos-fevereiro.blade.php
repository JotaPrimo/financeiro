<div class="accordion-item mt-3">
    <h2 class="accordion-header" id="headingProventoFevereiro">
    ...
    <div id="collapseFevereiro" class="accordion-collapse collapse {{ verificarMesAtualShow(\App\Models\Mes::FEVEREIRO) }}" aria-labelledby="headingProventoFevereiro" data-bs-parent="#accordionExample">
            ...
            <table class="table table-striped table-hover" id="tbl_proventos_abril">
                ...
                <tr>
                    <td class="text-success">
                        Total : {{ \App\Service\ProventoService::returnTotalProventoFormatado($proventosFevereiro) }}
                    </td>
                </tr>
            </table>
        </div>
