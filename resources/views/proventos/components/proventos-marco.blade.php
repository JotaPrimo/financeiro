<div class="accordion-item mt-3">
    <h2 class="accordion-header" id="headingProventoMarco">
    ...
    <div id="collapseMarco" class="accordion-collapse collapse" aria-labelledby="headingProventoMarco" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            <table class="table table-striped table-hover" id="tbl_proventos_marco">
                <thead>
                <tr>
                ...
                <tr>
                    <td class="text-success">
                        Total : {{ \App\Service\ProventoService::returnTotalProventoFormatado($proventosMarco) }}
                    </td>
                </tr>
            </table>
        </div>
